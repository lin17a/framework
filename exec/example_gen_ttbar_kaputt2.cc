...
int main() {
  ...
  std::cout << "everything until aggregate worked\n";
  ...
  std::cout << "ttbar aggregate worked\n";
...
//  };
  ...
  gen_ttbar.add_attribute("ttbar_mass", invariant_mass<2>(), 
                          "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass",
                          "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass");

  gen_ttbar.add_attribute("ttbar_angle", angle, 
                          "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass",
                          "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass");
...
//   add_attribute("ttbar_z", get_attr_function([](TLorentzVector sum){return sum.Z();}));
  ...
  std::cout << "adding ttbar attributes worked\n";
...
//                          "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass");
  ...
  gen_tt_ll_bb.add_attribute("ttbar_mass", invariant_mass<2>(), 
                             "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass",
                             "gen_particle::pt", "gen_particle::eta", "gen_particle::phi", "gen_particle::mass");
  ...
  std::cout << "everything until Histograms worked\n";
