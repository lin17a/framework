...
//        std::string file_string = strcat(dir_str,entry->d_name);
  ...
  hist_no_cut.make_histogram<TH1F>(filler_first_of(gen_ttbar, "ttbar_rapidity"), "ttbar_rapidity_no_cut", "", 100, -6.f, 6.f);
  ...
  hist_cut.make_histogram<TH1F>(filler_first_of(gen_ttbar, "ttbar_rapidity"), "ttbar_rapidity_cut", "", 100, -6.f, 6.f);
