{
  TFile *f1 = TFile::Open( "../hist_m600_w15_000_INT_PSEUDO/hist_cut.root" );
  TFile *f2 = TFile::Open( "../hist_m600_w15_000_RES_PSEUDO/hist_cut.root" );
  ...
  while ((key1=(TKey*)iter1.Next()) ) {
     ...
     try {
        ...
        std::string filename = std::string(hist_name1) + std::string("_cut_normal_vs_RES_PSEUDO.pdf");
