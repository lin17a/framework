...
template <typename Number2>
Number2 weight_ggHtt_juan_code(const HTT_Input<Number2>& httInput, res_int res_int) {
...
template <typename Number2>
Number2 weight_ggHtt_juan_paper(const HTT_Input<Number2>& httInput, res_int res_int) {
/*
struct HTT_Input {
       unsigned int HIGGS_OPTION; // 0: SCALAR only; 1: PSEUDOSCALAR only; 2: BOTH
...
Number2 compute_weight(Number1 pTop_pt, Number1 pTop_eta, Number1 pTop_phi, Number1 pTop_m,
                       ...
                       calc_weight_version version, higgs_type higgs_type, float mass, float width, res_int res_int)
{
  // what's that?
...
template <typename Number1, typename Number2>
auto calculate_weight(calc_weight_version version, higgs_type higgs_type, float mass, float width, res_int res_int)
{
